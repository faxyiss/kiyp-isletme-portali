      ...
      <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
        <div>
          ...
          <input
            ...
            required
            :disabled="isLoading"
            placeholder="Örn: Küp Şeker (5kg Kolili)"
          ...
          <div class="relative w-full">
            ...
            >
              <span
                ...
                :class="{ 'text-slate-400': !productForm.categoryId }"
              >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (productResponse.ok) {
      showSuccess('Ürün kartı başarıyla tanımlandı.')
      emit('success')
      emit('close')
    } else {
      showError(productData.message || 'Ürün kartı tanımlanırken hata oluştu.')
    }
  } catch (error) {
